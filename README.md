...
A simple Student Management System built using C# Windows Forms and SQL Server. 
It allows users to add, search, update, and delete student records through a friendly GUI.
...
subjecttab – Stores subjects and related details
attendancetab – Stores student attendance records
